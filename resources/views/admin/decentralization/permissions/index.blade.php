...
@section('content_header')
    <h1 class="title-header">Decentralization <span class="small font-weight-normal">Permisstions</span></h1>
@stop
@section('content')
    ...
    @endif
    <button class="btn btn-outline-primary mb-2" data-toggle="modal" data-target="#modalComfirmDelete">Add permission
    </button>
    <table class="table table-bordered text-center table-hover">
        <thead class="">
        <tr>
            <th>STT</th>
            <th class="w-50">Permisston name</th>
            <th>Created at</th>
            <th>Updated at</th>
            <th>View</th>
        </tr>
        ...
        @foreach($permissions as $permission)
            <tr>
                ...
                <td><a class="text-reset" href="{{route('admin.permissions.edit', ['permission' => $permission->id])}}"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <p class="modal-title" style="font-size: 2rem">Create a new permission</p>
                ...
                success: function (data) {
                    ...
                    if (Boolean(result.status)) {
                        ...
                        $('.modal-body').append('\n' +
                            ...
                            '                        <button type="button" class="close" data-dismiss="alert">&times;</button>\n' +
                            '                        <strong>Success!</strong> Create permission success\n' +
                            '                    </div>');
